...
{
    public final String keyGenerator(final int length) throws CryptoException
    {
        ...
        {
            throw new CryptoException("Rijndael.java: keyGenerator - length has to be one of these values: 128, 192, 256!");
        } 
        
        if(stringKey == null)
            throw new CryptoException("Rijndael.java: keyGenerator - result is null!");

        return stringKey;
    }

    public final String initialVector() throws CryptoException
    {
        String vector = null;
    ...
    public final String encrypt(final String algorithm, final String hexKey, final String hexIV, final String plaintext) throws CryptoException
    {
        ...
        try 
        {
            ...
            if(hexIV == null)
            {
                if(!algorithm.contains("ECB"))
                    throw new CryptoException("Rijndael.java: encrypt - algorithm does not contain ECB!");
        ...
        if(encryption == null)
            throw new CryptoException("Rijndael.java: encrypt - result is null!");

        return encryption;
    }

    public final String decrypt(final String algorithm, final String hexKey, final String hexIV, final String hexCiphertext) throws CryptoException
    {
        String decoded = null;
        ...
        if(decoded == null)
            throw new CryptoException("Rijndael.java: decrypt - result is null!");

        return decoded;
    }

    public void encryptFile(final String algorithm, final String hexKey, final String hexIV, 
                                            final File plaintext, final File hexCiphertext) throws CryptoException
    {
        try 
        {
            byte[] bytes = Hex.decode(hexKey);
    ...
    public void decryptFile(final String algorithm, final String hexKey, final String hexIV, 
                                            final File hexCiphertext, final File plaintext) throws CryptoException
    {
        try 
        {
            byte[] bytes = Hex.decode(hexKey);
    ...
    public final SealedObject encryptObject(final String algorithm, final String hexKey, final String hexIV, 
                                                final Serializable object) throws CryptoException
    {
        ...
        if(sealedObject == null)
            throw new CryptoException("Rijndael.java: encryptObject - result is null!");
            
        return sealedObject;
    }

    public final Serializable decryptObject(final String algorithm, final String hexKey, final String hexIV, 
                                                final SealedObject hexSealedObject) throws CryptoException
    {
        ...
        if(unsealObject == null)
            throw new CryptoException("Rijndael.java: decryptObject - result is null!");
